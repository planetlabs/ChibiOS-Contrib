...
static void start_channels(EICUDriver *eicup) {
  ...
  if (eicup->config->iccfgp[0] != NULL) {
    ...
    eicup->tim->CCMR1 &= ~STM32_TIM_CCMR1_IC1F_MASK;
  ...
  if (eicup->config->iccfgp[1] != NULL) {
    ...
    /* configure input filter duration */
    eicup->tim->CCMR1 &= ~STM32_TIM_CCMR1_IC2F_MASK;
  ...
  if (eicup->config->iccfgp[2] != NULL) {
    ...
    /* configure input filter duration */
    eicup->tim->CCMR2 &= ~STM32_TIM_CCMR2_IC3F_MASK;
    eicup->tim->CCMR2 |= STM32_TIM_CCMR2_IC3F(eicup->config->iccfgp[2]->filter & 0xf);
  }
  ...
  if (eicup->config->iccfgp[3] != NULL) {
    ...
    /* configure input filter duration */
    eicup->tim->CCMR2 &= ~STM32_TIM_CCMR2_IC4F_MASK;
    eicup->tim->CCMR2 |= STM32_TIM_CCMR2_IC4F(eicup->config->iccfgp[3]->filter & 0xf);
